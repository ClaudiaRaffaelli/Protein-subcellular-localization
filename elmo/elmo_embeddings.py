...
options_path = "./data/checkpoint_" + str(n) + "_" + str(stride) + "/options.json"
...
options_file = "./data/checkpoint_" + str(n) + "_" + str(stride) + "/options.json"
weight_file = "./data/weights/weights_" + str(n) + "_" + str(stride) + ".hdf5"
